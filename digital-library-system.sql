...
CREATE TABLE if not exists book_info (
    ...
    internal_code VARCHAR(50) UNIQUE,  -- for items without a real ISBN (comics, UPC/Diamond codes, etc.)
...
CREATE TRIGGER trg_book_info_updated
...
CREATE TABLE if not exists creator_role_type (
    ...
    creator_role_name VARCHAR(50) UNIQUE NOT NULL
);
...
CREATE TABLE if not exists book_author (
    ...
    creator_role_id INT NOT NULL REFERENCES creator_role_type(creator_role_id),
    PRIMARY KEY (book_id, author_id, creator_role_id)  -- allows multi-author configurations for books
);
...
CREATE TRIGGER trg_book_tracking_updated
...
INSERT INTO book_info (book_isbn, internal_code, book_title, publish_date, publisher, edition, issue_number, volume_number, page_amount) VALUES 
('9780451524935', NULL, '1984', '1949-06-08', 'Signet Classic', 'Centennial Edition', NULL, NULL, 328),
('9780141439518', NULL, 'Pride and Prejudice', '1813-01-28', 'Penguin Classics', 'Deluxe Edition', NULL, NULL, 480),
('9780060853983', NULL, 'Good Omens', '1990-05-01', 'William Morrow', 'International Edition', NULL, NULL, 412),
(NULL, 'COMIC-BATMAN-V2-01', 'Batman: The Court of Owls', '2011-09-21', 'DC Comics', 'First Printing', '1', 2, 32),
('9780000000099', NULL, 'Some Untitled Work', '2020-01-01', 'Unknown Press', NULL, NULL, NULL, NULL),
(NULL, 'COMIC-WATCHMEN-01', 'Watchmen', '1986-09-01', 'DC Comics', 'First Printing', '1', 1, 32);
